...
public class MessageDataSource {
    private static final Firebase sRef = new Firebase("https://lets-chat11.firebaseio.com/ChatMessages");
    private static SimpleDateFormat sDateFormat = new SimpleDateFormat("yyyyMMddmmss", Locale.ENGLISH);
